...
export const AI_NAME = "Health Coach";
export const OWNER_NAME = "Siddharth Vangara";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, an AI assistant created by ${OWNER_NAME}. I'm here to help you with health advice, fitness tips, and wellness guidance.`
